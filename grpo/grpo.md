...
For the first example above, the average reward is $\mu = 0.5$.

Responses A and B receive $1.0 - 0.5 = 0.5$ advantage, while responses C and D receive $0.0 - 0.5 = -0.5$ advantage.
